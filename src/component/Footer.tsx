        ...
        <>
            <div className="footer-top" style={{
                ...
                <div className="footer-top-info">
                    <div className="header-top-anime-footer">
                        <div className="">
                            <p>Top Anime</p>
                        </div>
                        <div className="more-footer-anime">
                            <p>more</p>
                        </div>
                    </div>
                    <div className="anime-title-footer">
                        <div className="list-anime-title-footer">
                            <div className="number-list-anime-footer"><p>1</p></div>
                            <div className=""><p> Sousou no Frieren</p></div>
                        </div>
                        <div className="list-anime-title-footer">
                            <div className="number-list-anime-footer"><p>2</p></div>
                            <div className=""><p>Fullmetal Alchemist: Brotherhood</p></div>
                        </div>
                        <div className="list-anime-title-footer">
                            <div className="number-list-anime-footer"><p>3</p></div>
                            <div className=""><p> Steins;Gate</p></div>
                        </div>
                        <div className="list-anime-title-footer">
                            <div className="number-list-anime-footer"><p>4</p></div>
                            <div className=""><p>Gintama</p></div>
                        </div>
                        <div className="list-anime-title-footer">
                            <div className="number-list-anime-footer"><p>5</p></div>
                            <div className=""><p>Shingeki no Kyojin Season 3 Part 2</p></div>
                        </div>
                    </div>
                </div>
                <div className="footer-top-info">
                    ...
                    <div className="anime-title-footer">
                        <div className="list-anime-title-footer">
                            <div className="number-list-anime-footer"><p>1</p></div>
                            <div className=""><p> Monogatari Series: Off & Monster Season</p></div>
                        </div>
                        <div className="list-anime-title-footer">
                            <div className="number-list-anime-footer"><p>2</p></div>
                            <div className=""><p>One Piece</p></div>
                        </div>
                        <div className="list-anime-title-footer">
                            <div className="number-list-anime-footer"><p>3</p></div>
                            <div className=""><p> Doupo Cangqiong: Nian Fan</p></div>
                        </div>
                        <div className="list-anime-title-footer">
                            <div className="number-list-anime-footer"><p>4</p></div>
                            <div className=""><p>"Oshi no Ko" 2nd Season</p></div>
                        </div>
                        <div className="list-anime-title-footer">
                            <div className="number-list-anime-footer"><p>5</p></div>
                            <div className=""><p>Tunshi Xingkong 4th Season</p></div>
                        </div>
                    </div>
                </div>
                <div className="footer-top-info">
                    ...
                    <div className="anime-title-footer">
                        <div className="list-anime-title-footer">
                            <div className="number-list-anime-footer"><p>1</p></div>
                            <div className=""><p>Lamperouge, Lelouch</p></div>
                        </div>
                        <div className="list-anime-title-footer">
                            <div className="number-list-anime-footer"><p>2</p></div>
                            <div className=""><p>Levi</p></div>
                        </div>
                        <div className="list-anime-title-footer">
                            <div className="number-list-anime-footer"><p>3</p></div>
                            <div className=""><p>Monkey D., Luffy</p></div>
                        </div>
                        <div className="list-anime-title-footer">
                            <div className="number-list-anime-footer"><p>4</p></div>
                            <div className=""><p> Lawliet, L</p></div>
                        </div>
                        <div className="list-anime-title-footer">
                            <div className="number-list-anime-footer"><p>5</p></div>
                            <div className=""><p>Roronoa, Zoro</p></div>
                        </div>
                    </div>
                </div>
            ...
            <div className="footer">
                <div className="footer-login-message-info">
                    <div className="footer-login-message">
                ...
                <div className="footer-info">
                    <p>�� 2024 My Animo List. All rights reserved.</p>
                    <p>Privacy Policy | Terms of Service</p>
                    <p>My Animo List is a fan-made website and does not endorse, sponsor, or promote the content of any anime, manga, or other media.</p>
